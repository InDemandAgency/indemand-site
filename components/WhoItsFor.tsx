...
const plateauedBullets = [
  ...
  "You're anxious about when the next slow season will hit and have no control over how it'll affect you",
...
const scalingBullets = [
  ...
  "You have a team (or are building one) and need qualified jobs filling your pipeline every week without worrying about slow seasons",
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="mt-12 text-center max-w-3xl mx-auto" data-animate data-delay="100">
          <p className="text-text-muted text-base md:text-lg leading-relaxed">
            In the span of 2 years, we&apos;ve helped business owners across industries generate{" "}
          ...
          <p className="mt-4 text-white font-bold text-base md:text-lg">
            The question is simple: do you have a system that can deliver that kind of growth on demand? That&apos;s exactly what we install.
          </p>
        </div>
      </div>
    </section>
